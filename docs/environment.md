...
Verified 2026-09-20 on Linux x86_64.
...
| Task worktree | `~/.agent-worktrees/rtl-relate/wednesday-feasibility-20260920` |
...
No sudo, system package installation, Python Z3 package, or NeuroAbs dependency was needed. `scripts/bootstrap_yosys.sh` uses uv to reproduce the isolated frontend. No baseline snapshot was frozen.
